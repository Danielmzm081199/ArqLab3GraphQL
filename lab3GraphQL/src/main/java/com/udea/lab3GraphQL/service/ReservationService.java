package com.udea.lab3GraphQL.service;

import com.udea.lab3GraphQL.entity.Flight;
import com.udea.lab3GraphQL.entity.Reservation;
import com.udea.lab3GraphQL.repository.FlightRepository;
import com.udea.lab3GraphQL.repository.ReservationRepository;
...
public class ReservationService {
    ...
    public Reservation reserveFlight(Long flightId, String passengerName, String
            seatNumber) {
...
// Generar el código de reserva
    ...
    private String generateReservationCode(String flightNumber) {
        return flightNumber + "-" + UUID.randomUUID().toString().substring(0,
                8).toUpperCase();
    }
}
